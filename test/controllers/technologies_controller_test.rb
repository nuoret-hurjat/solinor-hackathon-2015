...
class TechnologiesControllerTest < ActionController::TestCase
  ...
  test "should create technology" do
    assert_difference('Technology.count') do
      post :create, technology: { back: @technology.back, description: @technology.description, front: @technology.front, logo: @technology.logo, name: @technology.name, url: @technology.url }
    end
  ...
  test "should update technology" do
    patch :update, id: @technology, technology: { back: @technology.back, description: @technology.description, front: @technology.front, logo: @technology.logo, name: @technology.name, url: @technology.url }
    assert_redirected_to technology_path(assigns(:technology))
  end
